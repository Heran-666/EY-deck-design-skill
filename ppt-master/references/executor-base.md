...
Apply §2.1's family-resolution and sparse-accent rules to `spec_lock.md` typography (Quick: its transient §2 anchor). Under [`native-formula.md`](./native-formula.md), blocks use marker style and inline math inherits size and solid fill, exporting in Cambria Math with the project text language.
