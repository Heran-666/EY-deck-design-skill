...
def _release_graphics_findings(
    svg_files: list[Path],
) -> tuple[list[tuple[str, str, str]], list[tuple[str, str, bool]]]:
    """Read release blocks and valid placeholder diagnostics in one pass."""
...
''',
    ...
    release_blocked, reconstruction_only = _release_graphics_findings(native_files)
    if release_blocked:
        print(
